...
import asifImage from '../assets/images/asif.jpg';
      ...
      <div className="hero-container">
        <div className="hero-image">
          <div className="left-sidebar">
            <img className="me" src={asifImage} alt="Me" />
          </div>
          <div className="hero-socials">
            <a href="https://www.linkedin.com/in/muhammad-asif-zahoor/" target="_blank" rel="noopener noreferrer" className="social-link">
            ...
            <a href="https://github.com/Muhammad-Asif10710" target="_blank" rel="noopener noreferrer" className="social-link">
              <div className="social-circle">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="social-icon">
            ...
            <a href="https://www.instagram.com/masaf_7101" target="_blank" rel="noopener noreferrer" className="social-link">
              <div className="social-circle">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="social-icon">
